// Source: https://reactbits.dev/components/gradient-text
...
const GradientText = ({
  ...
  // Keep the root element semantic when used as a heading
  const MotionTag = (as === 'h1' ? motion.h1 : as === 'h2' ? motion.h2 : as === 'h3' ? motion.h3 : motion.div) as typeof motion.div
